...
output: main.o ${LIB_FOLDER}/lineOut.o ${LIB_FOLDER}/soundFile.o ${THIRD_PARTY_FOLDER}/loguru/loguru.o
	g++ main.o ${LIB_FOLDER}/lineOut.o ${LIB_FOLDER}/soundFile.o ${LIB_FOLDER}/libportaudio.a  ${LIB_FOLDER}/portaudio.h ${CFLAGS} -o ${EXECUTABLE_NAME}
